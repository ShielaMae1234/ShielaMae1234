...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `information management` SET `ID`='$ID',`Firstname`='$Firstname',`Lastname`='$Lastname',`MI`='$MI' WHERE id = $id";
...
<body>
  ...
  <div class="container">
    ...
    <?php
    $sql = "SELECT * FROM `information management` WHERE id = $id LIMIT 1";
    $result = mysqli_query($conn, $sql);
